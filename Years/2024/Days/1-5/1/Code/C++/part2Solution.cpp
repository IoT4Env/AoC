...
unsigned long get_total_similarity(int*, int*);
...
int main()
{
    ...
    unsigned long similarity = get_total_similarity(matrix[0], matrix[1]);
...
unsigned long get_total_similarity(int* column1, int* column2){
    unsigned long sum = 0;
